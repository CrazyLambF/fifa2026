...
description: 每日更新FIFA 2026世界杯观赛指南数据，包括比赛比分、射手榜、助攻榜、红黑榜、夺冠赔率等。当用户要求更新世界杯数据时使用此skill。
---
...
3. 替换 `getGoalsLeaderboard()` 函数中的 `scorers` 数组
4. 添加当日比赛的进球球员（ESPN可能未及时更新）
